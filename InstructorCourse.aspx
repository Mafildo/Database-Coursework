<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstructorCourse.aspx.cs" Inherits="Coursework.InstructorCourse" %>
...
<body>
    ...
    <div class="navbar">
       ...
       <a href="Dashboard.aspx"><div class="para"><span style="font-weight: bold; color: blue; font-size: 20px;">E</span>-Learning</div></a> 
        ...
        <div>
            ...
            <a href="InstructorCourse.aspx" class="active">Instructor Course</a>
    ...
    <h2 style="margin-left: 12px;">Instrcutor Course Table</h2>
    <form id="form1" runat="server">

        <div>
        </div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource5" DataKeyNames="INSTRUCTOR_ID,COURSE_ID,STUDENT_ID">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM &quot;INSTRUCTOR_COURSE&quot; WHERE &quot;INSTRUCTOR_ID&quot; = :INSTRUCTOR_ID AND &quot;COURSE_ID&quot; = :COURSE_ID AND &quot;STUDENT_ID&quot; = :STUDENT_ID" InsertCommand="INSERT INTO &quot;INSTRUCTOR_COURSE&quot; (&quot;INSTRUCTOR_ID&quot;, &quot;COURSE_ID&quot;, &quot;STUDENT_ID&quot;) VALUES (:INSTRUCTOR_ID, :COURSE_ID, :STUDENT_ID)" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM &quot;INSTRUCTOR_COURSE&quot;">
            <DeleteParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT * FROM &quot;INSTRUCTOR_COURSE&quot;"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server"></asp:SqlDataSource>
        <asp:FormView ID="FormView1" runat="server" DataSourceID="SqlDataSource5" DataKeyNames="INSTRUCTOR_ID,COURSE_ID,STUDENT_ID">
            <EditItemTemplate>
                INSTRUCTOR_ID:
